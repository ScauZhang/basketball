...
public class PullToRefreshLayout extends RelativeLayout implements OnTouchListener {
    ...
    private void initView(Context context)
    {
        ...
        rotateAnimation = (RotateAnimation) AnimationUtils.loadAnimation(context, R.anim.abc_grow_fade_in_from_bottom);
        refreshingAnimation = (RotateAnimation) AnimationUtils.loadAnimation(context, R.anim.abc_grow_fade_in_from_bottom);
        // 添加匀速转动动画
    ...
    public void refreshFinish(int refreshResult)
    {
        ...
        switch (refreshResult)
        {
            case REFRESH_SUCCEED:
                ...
                stateImageView.setBackgroundResource(Color.parseColor("#FFF"));
                break;
            case REFRESH_FAIL:
                // 刷新失败
                stateImageView.setVisibility(View.VISIBLE);
                stateTextView.setText("刷新失败");
                stateImageView.setBackgroundResource(Color.parseColor("#F00"));
                break;
            default:
                break;
        }
